...
/* Definitions for taskProcessUART */
osThreadId_t taskProcessUARTHandle;
const osThreadAttr_t taskProcessUART_attributes = {
  .name = "taskProcessUART",
  .priority = (osPriority_t) osPriorityNormal,
  .stack_size = 256 * 4
};
/* Definitions for queueUARTrx */
...
/* USER CODE BEGIN Header_processUARTrx */
/**
  * @brief  Function implementing the taskProcessUART thread.
